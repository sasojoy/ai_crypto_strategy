...
check and a full portfolio snapshot don't get conflated into one:
  ...
  2. A full holdings overview -- EVERY currently open leg across
     v1/v2/v3/v4/v5/v6, not just symbols near a threshold, with entry/SL/TP/
...
def load_all_legs():
    """Every currently open leg across v1/v2/v3/v4/v5/v6, flattened to one dict per
...
def build_holdings_message(legs, live_price_by_symbol):
    if not legs:
        return "\U0001F4C2 【持倉總覽】目前 v1/v2/v3/v4/v5/v6 皆無持倉"
